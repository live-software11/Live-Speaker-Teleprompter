...
│
├── docs/
│   ├── ARCHITETTURA_DEFINITIVA_Live_Speaker_Teleprompter.md  ← QUESTO FILE
...
│   └── System_Prompt_Claude_Live_Speaker_Teleprompter.md
│
...
| 18/03/2026 | 2.3.3 | Creazione ARCHITETTURA_DEFINITIVA. Companion module migrato a API v2 (@companion-module/base ^2.0.3). Aggiunta Guida_Refactoring_MainWindow, Primo_Prompt, System_Prompt Claude. Rules Cursor aggiornate con doc-sync. |
